        ...
        {Consultants.map((consultant, index) => (
          <div key={index} className="rounded-lg">
            ...
            <div className="flex justify-between items-center mt-2 px-3">
              ...
              <a href={`mailto:${consultant.email}`} className="text-[16px] no-underline text-black">{consultant.email}</a>
            </div>
          </div>
        ))}
      </div>
        ...
        {Developers.map((developer, index) => (
          <div key={index} className="rounded-lg">
            ...
            <div className="flex justify-between items-center mt-2 px-3">
              ...
              <a href={`mailto:${developer.email}`} className="text-[16px] no-underline text-black">{developer.email}</a>
            </div>
          </div>
        ))}
      </div>
